...
public class Roar extends StatusMove implements SwitchTargetMove {

    public Roar() {
        super("Roar", -1, Type.NORMAL, 32, false);
    }
    ...
    public void trySecondaryEffect(Pokemon attacker, Pokemon defender, Battle battle) {
        ...
        if (defender.getAbility() != SOUNDPROOF && defender.getAbility() != SUCTION_CUPS
