...
class StompingTantrumTests {

    private Pokemon user;
    private Pokemon target;
    private Battle battle;
    private StompingTantrum move;
    ...
    void testPowerDoublesIfLastMoveFailed() {
        ...
        assertThat(move.getPowerMultipliers(user, target, battle)).isEqualTo(StompingTantrum.MULTIPLIER);
    }
}
